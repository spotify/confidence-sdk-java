...
import com.spotify.confidence.common.ConfidenceUtils.ResolverClientTestUtils.ValueSchemaHolder;
...
final class FeatureProviderTest {
  ...
  public void regularResolveWithPath() {
    ...
    assertThat(evaluationDetails.getErrorMessage())
        .isEqualTo(
            "com.spotify.confidence.common.Exceptions$IllegalValuePath: Illegal path string '...'");
    assertThat(evaluationDetails.getValue()).isEqualTo(DEFAULT_VALUE);
  }
