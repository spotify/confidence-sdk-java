...
public class ResolveLogger implements Closeable {
  ...
  public static ResolveLogger createStarted(
  ...
  private record RuleResolveInfo(AtomicLong count, Map<String, AtomicLong> assignmentCounts) {
    public void increment(String assignmentId) {
      count.incrementAndGet();
