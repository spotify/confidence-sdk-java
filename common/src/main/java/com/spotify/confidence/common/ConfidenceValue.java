...
public abstract class ConfidenceValue {
  ...
  public static final ConfidenceValue NULL_VALUE =
      new ConfidenceValue() {
  ...
  public static ConfidenceValue fromProto(com.google.protobuf.Value protoValue) {
  ...
  public static class List extends ConfidenceValue {
    ...
    public static List fromProto(ListValue list) {
      return new List(
  ...
  public static class Struct extends ConfidenceValue {
    ...
    public static Struct fromProto(com.google.protobuf.Struct struct) {
      return new Struct(Maps.transformValues(struct.getFieldsMap(), ConfidenceValue::fromProto));
    }

    public static Struct ofMap(Map<String, ConfidenceValue> map) {
