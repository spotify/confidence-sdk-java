...
public class EventSenderEngineImpl implements EventSenderEngine {
  ...
  public static final Duration DEFAULT_MAX_FLUSH_INTERVAL = Duration.ofSeconds(60);
  public static final long DEFAULT_MAX_MEMORY_CONSUMPTION = 1024 * 1024 * 1024; // 1GB
  ...
  public EventSenderEngineImpl(String clientSecret, ManagedChannel channel, Clock clock) {
    this(
        DEFAULT_BATCH_SIZE,
  ...
  @VisibleForTesting
  public long getEstimatedMemoryConsumption() {
